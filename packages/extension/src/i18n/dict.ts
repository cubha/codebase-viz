...
const KO: Dict = {
  ...
  'db.ormClass': 'ORM 클래스명 (엔티티 선언에서 추론)',
  // viewer.html — tabs
  ...
  'search.matchCount': '{n}건 일치',
  'search.noMatch': '일치 없음',
...
const EN: Dict = {
  ...
  'db.sidebar.tables': 'Tables',
  'db.ormClass': 'ORM class name (inferred from entity declaration)',
  'tab.rendering': 'Rendering Architecture',
  'tab.screenComponent': 'Screen–Component',
...
const JA: Dict = {
  ...
  'db.ormClass': 'ORM クラス名 (エンティティ宣言から推論)',
  'tab.rendering': 'Rendering Architecture',
  'tab.screenComponent': 'Screen–Component',
  'tab.dbScreen': 'データフロー',
  'tab.sequence': 'シーケンス',
